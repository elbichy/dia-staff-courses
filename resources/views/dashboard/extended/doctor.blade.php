			...
			<div class="gradient-45deg-light-blue-cyan gradient-shadow min-height-100 white-text">
				<div class="padding-4">
					...
					<div class="col s8 m8 right-align">
						<h5 class="mb-0">{{ $doctor_treatments_today->count() }}</h5>
		...
		<div class="col s12 m6 l3">
			<div class="gradient-45deg-amber-amber gradient-shadow min-height-100 white-text">
				<div class="padding-4">
					...
					<div class="col s8 m8 right-align">
						<h5 class="mb-0">{{ $doctor_treatments_pending->count() }}</h5>
						<p class="no-margin">Pending Enc.</p>
					</div>
				</div>
			</div>
		</div>
		<a href="{{ route('doctor_successful') }}" class="col s12 m6 l3">
			<div class="gradient-45deg-green-teal gradient-shadow min-height-100 white-text">
				<div class="padding-4">
					...
					<div class="col s8 m8 right-align">
						<h5 class="mb-0">{{ $doctor_treatments_success->count() }}</h5>
						<p class="no-margin">Successful Enc.</p>
					</div>
				</div>
			</div>
		</a>
		<a href="{{ route('doctor_cancelled') }}" class="col s12 m6 l3">
			<div class="gradient-45deg-red-pink gradient-shadow min-height-100 white-text">
				<div class="padding-4">
					...
					<div class="col s8 m8 right-align">
						<h5 class="mb-0">{{ $doctor_treatments_cancelled->count() }}</h5>
...
<div class="sectionTableWrap" style="padding-top:0px;">
	...
	<table class="highlight responsive-table centered">
		...
		<tbody>
			@foreach($doctor_treatments_pending as $treatment)
				...
				<tr>
					...
					<td>
						<a href="{{ route('doctor_diagnoses', $treatment->id) }}" class="waves-effect waves-light btn modal-trigger">Diagonise</a>
					</td>
				</tr>
				@endif
			@endforeach
			@empty($doctor_treatments_pending)
				<tr>
					<td colspan="7" style="text-align:center;">No Data Available</td>
				</tr>
			@endempty
			@if($doctor_treatments_pending == NULL)
				<tr>
					<td colspan="7" style="text-align:center;">No Data Available</td>
				</tr>
			@endif
