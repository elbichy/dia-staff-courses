	...
	<div class="row mt-1" style="margin-bottom:6px;">
		<div class="col s12 m6 l3">
			<div class="gradient-45deg-light-blue-cyan gradient-shadow min-height-100 white-text">
				<div class="padding-4">
					<div class="col s4 m4">
						<i class="material-icons background-round mt-5 small">format_list_numbered</i>
					</div>
		...
		<div class="col s12 m6 l3">
			<div class="gradient-45deg-amber-amber gradient-shadow min-height-100 white-text">
				<div class="padding-4">
					<div class="col s4 m4">
						<i class="material-icons background-round mt-5 small">loop</i>
					</div>
					<div class="col s8 m8 right-align">
		...
		<a href="#" class="col s12 m6 l3">
			<div class="gradient-45deg-green-teal gradient-shadow min-height-100 white-text">
				<div class="padding-4">
					<div class="col s4 m4">
							<i class="fas fa-globe-africa background-round mt-5 fa-2x"></i>
					</div>
					<div class="col s8 m8 right-align">
						<h5 class="mb-0">654</h5>
						<p class="no-margin">Local Courses</p>
					</div>
				</div>
			</div>
		</a>
		<div class="col s12 m6 l3">
			<div class="gradient-45deg-red-pink gradient-shadow min-height-100 white-text">
				<div class="padding-4">
					<div class="col s4 m4">
						<i class="fas fa-globe-americas background-round mt-5 fa-2x"></i>
					</div>
					<div class="col s8 m8 right-align">
						<h5 class="mb-0">067</h5>
						<p class="no-margin">Foreign Courses</p>
					</div>
				</div>
			</div>
		</div>
